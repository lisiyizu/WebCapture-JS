...
(function (window) {
    ...
    var Board = {
        ...
        _initDraw: function () {
            var preData = this.context.getImageData(0, 0, 1204, 530);
            //空绘图表面进栈
        ...
        _draw: function (oCanvas, context) {
            ...
            oCanvas.onmousedown = function (e) {
                ...
                _this.context.moveTo(canvasX, canvasY - 70);
                //当前绘图表面状态
                ...
                document.onmousemove = function (e) {
                    if (mousedown) {
                        var x2 = e.clientX,
                            ...
                            canvasY2 = y2 - top;
                        if (t == oCanvas) {
                            _this.context.lineTo(canvasX2, canvasY2 - 70);
